...
namespace WebImmobilier.Controllers
{
    public class AppartementsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            Appartement appartement = null;// db.biens.Find(id);
            if (appartement == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "IdBien,DescriptionBien,SuperficieBien,LocaliteBien,NbreSalleEau,NbreCuisine,NbreToilette,IdProprio,NbreSalle")] Appartement appartement)
        {
            ...
            ViewBag.IdProprio = new SelectList(db.proprietaire, "IdProprio", "NomProprio", appartement.IdProprio);
            return View(appartement);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdBien,DescriptionBien,SuperficieBien,LocaliteBien,NbreSalleEau,NbreCuisine,NbreToilette,IdProprio,NbreSalle")] Appartement appartement)
        {
            if (ModelState.IsValid)
            {
